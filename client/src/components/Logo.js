...
// Logo SVG: bandera de Venezuela + pin de ubicación
// Amarillo #ffcc00 · Azul #00247d · Rojo #cf142b
export default function Logo({ size = 32 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      {/* Bandera de fondo — tricolor */}
      ...
      {/* Estrellas blancas en arco sobre franja azul */}
      ...
      {/* Pin de ubicación blanco superpuesto */}
